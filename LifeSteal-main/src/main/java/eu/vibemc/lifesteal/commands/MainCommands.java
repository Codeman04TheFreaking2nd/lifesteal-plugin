...
public class MainCommands {
    public static CommandAPICommand getMainCommands() {
        return new CommandAPICommand("lifesteal")
                ...
                .executes((sender, args) -> {
                    ...
                    sender.sendMessage("§aCreated by §e§lCodeman04");
                    sender.sendMessage("§6§lLifeSteal");
                })
    ...
    private static CommandAPICommand getHelpCommand() {
        return new CommandAPICommand("help")
                ...
                .executes((sender, args) -> {
                    sender.sendMessage("§aAnswers to most questions can be found by asking plugin dev:");
                    sender.sendMessage("§6§lLifesteal");
                    sender.sendMessage("§aIf you §c§ldon't §r§afind an answer to your question there, ask Codeman for help:");
                    sender.sendMessage("§6§lDiscord: Codeman04Thefreaking2nd");
                });
    }
